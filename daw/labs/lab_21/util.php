<?php
  ...
  function getEmpleados(){
    ...
    while($row = $res->fetch_array(MYSQLI_BOTH)){
      ...
      <div class="row">
        ...
        <div class="col s3">
          <a href="editar.php?id='.$row["id"].'" class="btn-floating disabled"><i class="material-icons right">edit</i></a>
          <a href="eliminar.php" class="btn-floating disabled"><i class="material-icons">delete_forever</i></a>
        </div>
      </div>';
    }
  ...
  function nuevaEntrada(){
    ...
    guardarEmpleado($nombre, $rol, $departamento);
  }
  ...
  function guardarEmpleado($nombre, $rol, $departamento){
    $db = conectDb();
    $query = "CALL crearEmpleado('".$nombre."','".$rol."','".$departamento."')";
    if (!$db->query($query)) {
